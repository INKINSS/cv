...
const Proyects = () => {
    return (
        <article className="mt-16">
            ...
            <div>
                {data.map((item) => (
                    <section className='bg-customBlack text-customWhite my-8 py-8 px-7 hover:bg-customWhite hover:text-customBlack transition-all duration-200 border hover:border-customBlack' key={item.id}>
